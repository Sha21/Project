...
<c:url value="/admin/addcategory/viewcategory/${c.id}" var="viewUrl"></c:url>
<c:url value="/admin/addcategory/deletecategory/${c.id}" var="deleteUrl"></c:url>
<c:url value="/admin/addcategory/geteditform/${c.id}" var="editUrl"></c:url>
<tr>
