...
<!-- <nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="https://en.wikipedia.org/wiki/Interior_design">About Us</a></li>
    </ul>
...
<div class="container-fluid">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <img class="first-slide home-image" src="resources/images/a.jpg" alt="first slide" style="width:500%">
      ...
      <div class="item">
        <img class="second-slide home-image" src="resources/images/i.jpg" alt="first slide" style="width:500%">
         <div class="carousel-caption">
          <h3>Kitchen</h3>
          <p>Luxury Kitchen</p>
        </div>
      ...
      <div class="item">
    <img class="third-slide home-image" src="resources/images/j.jpg" alt="first slide" style="width:500%">
<div class="carousel-caption">
          <h3>Living Room</h3>
          <p>Impressive Living Space</p>
        </div>
      </div>

 <div class="item">
        <img class="fourth-slide home-image" src="resources/images/k.jpg" alt="first slide" style="width:500%">
<div class="carousel-caption">
          <h3>Living Room</h3>
          <p>Impressive Living Space</p>
        </div>
      ...
      <div class="Rounded Corners">
       <!--<c:url value="/admin/addproduct/viewproduct" var="url4"></c:url>-->
        <a href="http://www.housebeautiful.com/room-decorating/kitchens/g623/beautiful-designer-kitchens/" target="_blank">
              <h3>Kitchen</h3>
     <img class="fifth-slide home-image" src="resources/images/b.jpg" alt="first slide" style="width:100%">
    ...
    <div class="col-md-6">
      <div class="Rounded Corners">
        <a href="http://photos.hgtv.com/rooms/viewer/living-space/living-room" target="_blank">
                <h3>Living Room</h3>
          <img class="sixth-slide home-image" src="resources/images/h.jpg" alt="first slide" style="width:100%">
