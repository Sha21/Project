...
public class ProductController {
	...
	{
		List<Addcategory> categories=productService.getAllCategories();
	 ...
	 public String saveProduct(@Valid @ModelAttribute(name="product") Addproduct product,BindingResult result,Model model )
    {
    	...
    	Path path=Paths.get("C:\\Users\\SHARMILA\\workspace\\InteriorDes_front\\src\\main\\webapp\\WEB-INF\\resources\\images\\"+product.getId()+".png");
    	try {
